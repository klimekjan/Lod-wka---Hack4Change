...
function NotificationCenter() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {otwarty && (
        <div
          className={`fixed left-1/2 -translate-x-1/2 top-[94px] w-[calc(100vw-1.5rem)] max-w-80 rounded-xl shadow-2xl z-50 overflow-hidden md:absolute md:left-auto md:translate-x-0 md:right-0 md:top-full md:mt-2 md:w-80 ${zamykaniePopupu ? 'animate-slide-down-out' : 'animate-slide-down'}`}
          style={{
            background: light
